...
func TestMaxIntFront(t *testing.T) {
	...
	{
		nums := []int8{4, 3, 2, 1}
		if mathematics.Max(nums[0], nums[1:]...) != 4 {
			t.Error()
		}
	}
	// int16
...
func TestMaxIntNegative(t *testing.T) {
	...
	{
		nums := []int{-1, -2, -3, -4}
		if mathematics.Max(nums[0], nums[1:]...) != -1 {
			t.Error()
		}
	}
...
func TestMaxFloatFront(t *testing.T) {
	// float32
	{
		...
		if mathematics.Max(nums[0], nums[1:]...) != 4.0 {
			t.Error()
		}
	}
	// float64
...
func TestMaxFloatNegative(t *testing.T) {
	...
	{
		nums := []float32{-1.0, -2.0, -3.0, -4.0}
		if mathematics.Max(nums[0], nums[1:]...) != -1.0 {
			t.Error()
		}
	}
...
func TestMaxStringFront(t *testing.T) {
	strs := []string{"d", "c", "b", "a"}
	if mathematics.Max(strs[0], strs[1:]...) != "d" {
		t.Error()
	}
}
